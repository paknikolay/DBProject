...
#include "../Database_shcedule/sign_up.h"
...
QT_MOC_LITERAL(3, 31, 23) // "on_pushButton_2_clicked"
    ...
    "Sign_up\0on_pushButton_clicked\0\0"
...
void Sign_up::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Sign_up *_t = static_cast<Sign_up *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject Sign_up::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Sign_up.data,
      qt_meta_data_Sign_up,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Sign_up::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Sign_up.stringdata0))
        return static_cast<void*>(const_cast< Sign_up*>(this));
